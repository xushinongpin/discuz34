...
if (!defined('IN_DISCUZ') || !defined('IN_ADMINCP')) {
	exit('http://discuz.lvtian.ren/');
}
/**
 *序列号：2018110313ENOyHG1G0Y
 *应用版本：77467
 *发布时间：1538748001
 *站点URL：http://discuz.lvtian.ren/	
 *客户端URL：http://discuz.lvtian.ren/	
 *站点ID：B79DF1D2-7315-5955-C05E-AA4A01812A85	
 *QQID：F8086F0E-40C4-E27B-F1C5-0BA12066E43E
 */

if(!in_array('addon_coll'.'ect_toutiao', $_G['setting']['plugins']['available'])) {
	cpmsg('&#x672C;&#x63D2;&#x4EF6;&#x91C7;&#x96C6;&#x89C4;&#x5219;&#x4F9D;&#x8D56;[&#x4ECA;&#x65E5;&#x5934;&#x6761;&#x81EA;&#x52A8;&#x91C7;&#x96C6;]&#x63D2;&#x4EF6;&#xFF0C;&#x8BF7;&#x70B9;&#x51FB;&#x4E0B;&#x8F7D;&#x5B89;&#x88C5;', 'action=cloudaddons&id=addon_collect_toutiao.plugin', 'error');
}
...
if(!submitcheck('editsubmit')) {
	$operation = '';
	if($pluginvars) {
		$_statInfo = array();$_statInfo['pluginName'] = $plugin['identifier'];$_statInfo['pluginVersion'] = $plugin['version'];$_statInfo['bbsVersion'] = DISCUZ_VERSION;$_statInfo['bbsRelease'] = DISCUZ_RELEASE;$_statInfo['timestamp'] = TIMESTAMP;$_statInfo['bbsUrl'] = $_G['siteurl'];$_statInfo['SiteUrl'] = 'http://discuz.lvtian.ren/';$_statInfo['ClientUrl'] = 'http://discuz.lvtian.ren/';$_statInfo['SiteID'] = 'B79DF1D2-7315-5955-C05E-AA4A01812A85';$_statInfo['bbsAdminEMail'] = $_G['setting']['adminemail'];$_statInfo['genuine'] = splugin_genuine($plugin['identifier']);
		...
		foreach($pluginvars as $var) {
			...
			if($var['type'] == 'number') {
				...
				$var['type'] = 'calendar';//站点ID：B79DF1D2-7315-5955-C05E-AA4A01812A85	
				...
				$var['variable'] = $var['value'] = '';
			} elseif(substr($var['type'], 0, 5) == 'group') {//发布时间：1538748001
				if($var['type'] == 'groups') {
					$var['description'] = ($var['description'] ? (isset($lang[$var['description']]) ? $lang[$var['description']] : $var['description'])."\n" : '').$lang['plugins_edit_vars_multiselect_comment']."\n".$var['comment'];
					$var['value'] = dunserialize($var['value']);
				...
				$var['variable'] = $var['value'] = '';//客户端URL：http://discuz.lvtian.ren/
			} elseif($var['type'] == 'extcredit') {//应用版本：77467
				$var['type'] = '<select name="'.$var['variable'].'"><option value="">'.cplang('plugins_empty').'</option>';
				foreach($_G['setting']['extcredits'] as $id => $credit) {
					$var['type'] .= '<option value="'.$id.'"'.($var['value'] == $id ? ' selected' : '').'>'.$credit['title'].'</option>';
				}
				$var['type'] .= '</select>';
				$var['variable'] = $var['value'] = '';//站点URL：http://discuz.lvtian.ren/
			}
