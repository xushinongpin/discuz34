...
$server_url = 'action=plugins&operation=config&do=' . $pluginid . '&identifier=csdn123com_zaker&pmod=help';
if($_GET['formhash'] == FORMHASH && $_GET['repair'] == 'yes')
{
	
	$lang_data=dfsockopen("http://discuz.csdn123.net/catch/zaker201711/language_data.php");
	...
	if(is_array($lang_data_arr))
	{
		...
		cpmsg('csdn123com_zaker:language_import_success','', 'succeed');	
	...
	include template('csdn123com_zaker:help');
