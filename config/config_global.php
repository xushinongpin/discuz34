...
$_config['db']['1']['dbuser'] = 'ilvtian_cc';
$_config['db']['1']['dbpw'] = 'kfEXyx67XC';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'ilvtian_cc';
$_config['db']['1']['tablepre'] = 'zhanqun_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = 'wQ00Uq_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'qyPc_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '2e8963ad3c71d7526cf5fdd8578e4271d4oAuyxWK08QVbPMU5';
